...
describe("Form", () => {
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const {getByText} = render(<Form interviewers={interviewers} student='BaggageTrain' onSave={onSave}/>)
    /* 3. Click the save button */
    fireEvent.click(getByText('Save'))
  ...
  xit("calls onSave function when the name and interviewer is defined", () => {
    ...
    const {queryByText} = render (<Form student="Lydia Miller-Jones" interviewer={1} interviewers={interviewers} onSave={onSave}/>)
    /* 3. Click the save button */
